        ...
        >
            ...
            <td className="flex items-center justify-between border-b border-gray-200 p-2 text-right md:table-cell md:p-4 md:text-left dark:text-white">
                ...
                <div className="flex gap-2">
                    <a
                        href={`https://web.whatsapp.com/send?phone=88${student.mobileNumber}&text=প্রিয় ${student.name} আইডি ${student.id} কোর্স ${student.courseNames} আপনার ফি ${student.dues} টাকা এখনো পরিশোধ হয়নি। অনুগ্রহ করে পরিশোধ করার জন্য বিনীতভাবে অনুরোধ করা হচ্ছে   ধন্যবাদ।`}
