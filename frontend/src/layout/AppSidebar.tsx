...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      { name: "Add Category", path: "/blank" },
      { name: "All Category", path: "/error-404" },
    ],
  },
];
...
const othersItems: NavItem[] = [
  {
    icon: "fas fa-plug", // FontAwesome icon class for PlugInIcon
    name: "Authentication",
    subItems: [
        ...
        >
          {nav.subItems ? (
            ...
            >
              ...
              {(isExpanded || isHovered || isMobileOpen) && (
                <i
                  className={`fas fa-chevron-down ml-auto w-5 h-5 transition-transform duration-200 ${
